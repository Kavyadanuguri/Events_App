...
class Events extends Component {
  state = {itemStatus: undefined}

  updateContainerStatus = id => {
    const exactItem = eventsList.find(each => each.id === id)

    this.setState({itemStatus: exactItem.registrationStatus})
  }
  ...
  render() {
    ...
    return (
      <div className="container">
        ...
        <ActiveEventRegistrationDetails itemStatus={itemStatus} />
      </div>
    )
  }
}
